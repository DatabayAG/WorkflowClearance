...
/**
 * Class ilWorkflowClearanceTableGUI
 */
class ilWorkflowSelectionTableGUI extends ilTable2GUI
{
	/** @var ilCtrl $ilCtrl */
	protected $ilCtrl;
	...
	public function __construct($parent_obj, $parent_cmd, $template_context = '')
	{
		...
		$this->setRowTemplate('tpl.wfe_sel_row.html',
